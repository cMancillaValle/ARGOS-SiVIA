"""
ARGOS - SiViA · Backend  (app.py actualizado con RBAC + Evidencias)
--------------------------------------------------------------------
Cambios respecto a la versión anterior:
  · Registra el nuevo blueprint rbac_bp  en /api/rbac
  · NUEVO: ruta /api/camaras/evidencia/<path:filepath> para servir
    las capturas guardadas por capture_manager (issue #21)
...
def health():
    return jsonify({
        ...
        'endpoints': [
            ...
            'GET  /api/camaras/evidencia/<path:filepath>',
        ]
    })
